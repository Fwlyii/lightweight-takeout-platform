<template>
    <div class="ai-chatbot">
        <!-- AI客服触发按钮 -->
        <div class="chat-trigger" @click="handleClick" :class="{ active: showChat }">
                ...
                <div class="chat-input">
                    ...
                    <div class="input-container">
                        <div class="input-wrapper">
                            <input v-model="inputMessage" @keyup.enter="sendMessage" @input="onInputChange"
                                placeholder="输入您的问题..." :disabled="isTyping" ref="messageInput" maxlength="500" />
