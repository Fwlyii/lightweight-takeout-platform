...
.ai-sheet {
  ...
  background: #fff;
  box-shadow: 0 -14px 40px rgba(12, 52, 86, .2);
}
...
.ai-avatar {
  ...
  color: #fff;
  font-size: 17px;
  box-shadow: 0 5px 14px rgba(22, 119, 255, .26);
}

.sheet-title { min-width: 0; flex: 1; }
.sheet-title strong { display: block; color: #17324f; font-size: 16px; font-weight: 800; }
.sheet-title small { display: block; margin-top: 2px; color: #8aa0b2; font-size: 11px; }
...
.chat-bubble.assistant { align-self: flex-start; background: #f2f7fd; color: #31556d; border-top-left-radius: 6px; }
.chat-bubble.user { align-self: flex-end; background: linear-gradient(135deg, #4da3ff, #1677ff); color: #fff; border-top-right-radius: 6px; }
...
.candidate-card {
  ...
  border-radius: 16px;
  background: #fff;
  box-shadow: 0 6px 16px rgba(39, 86, 114, .06);
}

.candidate-card img { width: 62px; height: 62px; flex: 0 0 62px; border-radius: 12px; object-fit: cover; background: #eef5f9; }
.candidate-copy { min-width: 0; flex: 1; }
.candidate-copy strong { display: block; overflow: hidden; color: #17324f; font-size: 14px; font-weight: 700; text-overflow: ellipsis; white-space: nowrap; }
.candidate-copy span { display: block; margin-top: 3px; overflow: hidden; color: #8aa0b2; font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }
.candidate-meta { display: flex; align-items: baseline; gap: 8px; margin-top: 5px; }
.candidate-meta b { color: #f27635; font-size: 12px; }
.candidate-meta em { color: #1677ff; font-size: 12px; font-style: normal; font-weight: 700; }
...
.recording-copy strong, .image-copy strong { display: block; color: #17324f; font-size: 13px; }
.recording-copy small, .image-copy small { display: block; margin-top: 2px; overflow: hidden; color: #8aa0b2; font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }
.recording-time { color: #1677ff; font-size: 13px; font-weight: 700; }
...
.sheet-input input[type="text"]:focus { border-color: #85c2ff; background: #fff; }
...
.icon-button:disabled { color: #b8cbd7; cursor: not-allowed; }
...
.send-button:disabled { background: #c3d6e4; box-shadow: none; cursor: not-allowed; }
