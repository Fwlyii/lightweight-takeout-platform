...
@media (max-width: 560px) {
  .admin-home .hero-line { display: none; }
  .admin-home .date-row { grid-template-columns: minmax(0, 1fr) auto minmax(0, 1fr); }
  .admin-home .filter-label { grid-column: 1 / -1; }
  .admin-home .date-input input { padding-right: 8px; }
  .admin-home .date-input i { display: none; }
}
