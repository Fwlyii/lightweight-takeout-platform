...
.logout-btn {
  ...
  max-width: 500px;
  margin: 0 auto 20px;
  background: linear-gradient(135deg, var(--fwl-brand, #2782dd), var(--fwl-brand-soft, #61c8f4)); /* 红色系，与主题和谐 */
  color: white;
  border: none;
  border-radius: 12px;
  padding: 12px 20px;
  ...
  align-items: center;
  gap: 8px;
  box-shadow: 0 4px 12px rgba(var(--fwl-brand-rgb, 60, 140, 238), 0.3);
  transform: translateY(-40px);
  z-index: 2;
}
.logout-btn:hover {
  background-color: var(--fwl-brand, #0085e0);
  box-shadow: 0 6px 16px rgba(var(--fwl-brand-rgb, 63, 95, 241), 0.4);
}
.logout-btn svg {
  color: white;
  width: 1.2em;
...
.avatar {
  ...
  box-shadow: 0 6px 20px rgba(var(--fwl-brand-rgb, 0, 151, 255), 0.3);
  flex-shrink: 0;
...
.review-tab.active {
  color: var(--fwl-brand, #0097ff);
  border-bottom: 3px solid var(--fwl-brand, #0097ff);
}
.review-content {
  display: none;
  padding: 0;
...
.review-btn:hover {
  background: var(--fwl-brand, #0085e0);
}
.modal-overlay {
  position: fixed;
  top: 0;
...
.admin-container { background: var(--fwl-surface, #f5f9fd); color: var(--fwl-ink, #24405c); }
.admin-container .container { background: var(--fwl-surface, #f5f9fd); border-radius: 0; box-shadow: none; padding-top: 88px; padding-bottom: 88px; }
.admin-container .top-background { height: 64px; background: var(--fwl-brand, #0097ff); background-image: none; border-radius: 0; box-shadow: 0 1px 0 rgba(var(--fwl-brand-strong-rgb, 0, 83, 145), 0.15); }
...
.admin-container .logout-btn { background: var(--fwl-brand, #0097ff); box-shadow: none; border-radius: 7px; transform: none; }
.admin-container .logout-btn:hover { background: var(--fwl-brand, #087dcc); box-shadow: none; }
...
<style scoped>
.stats-toolbar{display:flex;align-items:center;gap:8px;flex-wrap:wrap;width:calc(100% - 32px);max-width:568px;margin:16px auto 0;color:var(--fwl-muted, #668095);font-size:13px}.stats-toolbar input{border:1px solid var(--fwl-border, #d7e5ef);border-radius:6px;padding:7px;color:var(--fwl-muted, #49677f);min-width:0;flex:1 1 120px}.stats-toolbar button{border:0;border-radius:6px;padding:7px 12px;background:var(--fwl-brand, #168bd1);color:#fff;cursor:pointer;flex:0 0 auto}.stats-toolbar .export-btn{background:#fff;color:var(--fwl-brand, #168bd1);border:1px solid var(--fwl-brand, #168bd1)}.stats-summary{width:100%;margin-left:0;color:var(--fwl-muted, #3d6d8c)}.stats-container{transform:none;margin-top:16px}
.stat-card.users svg,.stat-card.shops svg,.stat-card.revenue svg{color:var(--fwl-brand, #2b8bc8)}
</style>
