  ...
  <main class="admin-home" :class="{ 'admin-home-ready': pageReady }">
    ...
    <section class="dashboard-panel chart-panel" aria-labelledby="trend-title">
      ...
      <div v-if="trend.length" class="chart-wrap">
        <svg class="revenue-chart" viewBox="0 0 360 170" role="img" aria-label="营业额趋势图">
          ...
          <g class="chart-points">
            <circle v-for="point in chartPoints" :key="point.day" :cx="point.x" :cy="point.y" r="3.7"></circle>
          </g>
    ...
    <section class="dashboard-panel review-panel" aria-labelledby="review-title">
      <div class="review-tabs" role="tablist" aria-labelledby="review-title">
        <button id="review-title" type="button" role="tab" :aria-selected="activeTab === 'user-review'" :class="{ active: activeTab === 'user-review' }" @click="activeTab = 'user-review'">用户审核（{{ merchantApplications.length }}）</button>
        <button type="button" role="tab" :aria-selected="activeTab === 'shop-review'" :class="{ active: activeTab === 'shop-review' }" @click="activeTab = 'shop-review'">商铺审核（{{ shopApplications.length }}）</button>
      </div>
