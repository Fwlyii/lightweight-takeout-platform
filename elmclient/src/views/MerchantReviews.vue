...
<style scoped>
.reviews-page{min-height:100vh;background:var(--skin-surface, #f5f8fc);color:var(--skin-ink, #29445d)}header{height:56px;background:var(--skin-brand, #168bd1);color:#fff;display:flex;align-items:center;gap:12px;padding:0 16px}header button{border:0;background:none;color:#fff;font-size:30px}h1{font-size:18px;margin:0}main{max-width:680px;margin:auto;padding:16px}.empty{text-align:center;color:var(--skin-muted, #8aa0b2);padding:60px 0}.review-card{background:#fff;border:1px solid var(--skin-border, #deebf4);border-radius:10px;padding:15px;margin-bottom:12px}.review-head{display:flex;align-items:center;gap:10px}.review-head strong{color:var(--skin-ink, #385b75)}.review-head time{margin-left:auto;color:var(--skin-subtle, #9aacb9);font-size:12px}.stars{color:#efb33a;letter-spacing:1px}.review-card p{color:var(--skin-muted, #526d82);line-height:1.6;margin:12px 0}.reply{background:var(--skin-surface, #f3f8fc);border-left:3px solid var(--skin-brand, #168bd1);padding:8px 10px;color:var(--skin-muted, #557186);font-size:13px}.reply-form{display:flex;gap:8px}.reply-form input{min-width:0;flex:1;border:1px solid var(--skin-border, #d6e4ef);border-radius:6px;padding:8px}.reply-form button{border:0;background:var(--skin-brand, #168bd1);color:#fff;border-radius:6px;padding:0 14px}
</style>
