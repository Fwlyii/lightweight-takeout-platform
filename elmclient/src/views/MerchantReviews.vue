<template>
  <div class="reviews-page"><header><button @click="$router.back()">‹</button><h1>顾客评价</h1><MerchantLogoutButton /></header><main>
