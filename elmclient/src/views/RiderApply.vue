...
input:focus {
    border-color: #13a98b;
    box-shadow: 0 0 0 4px rgba(19, 169, 139, .1);
}
...
.vehicle-grid button.selected {
    ...
    background: #effcf8;
    color: #07836d;
    box-shadow: inset 0 0 0 1px #13a98b;
}
...
.primary {
    color: #fff;
    background: linear-gradient(135deg, #08a88a, #24c8a1);
    box-shadow: 0 12px 24px rgba(8, 168, 138, .24);
}
