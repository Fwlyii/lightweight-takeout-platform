...
export default defineComponent({
  ...
  setup() {
    ...
    const quickQuestions = ['20元以内吃什么', '查看我的最近订单', '配送一般需要多久', '会员有哪些权益']
...
.assistant-page { min-height: 100vh; background: var(--skin-surface, #f4f7fa); color: var(--skin-ink, #243b53); }
button, input, textarea { font: inherit; }
button { cursor: pointer; }
button:disabled { cursor: not-allowed; opacity: .55; }
.page-header { min-height: 64px; padding: 10px max(14px, calc((100% - 1080px) / 2)); display: flex; align-items: center; gap: 12px; background: #fff; border-bottom: 1px solid var(--skin-border, #dce6ee); position: sticky; top: 0; z-index: 20; }
.header-copy { flex: 1; min-width: 0; }.header-copy h1 { margin: 0; font-size: 18px; }.header-copy p { margin: 3px 0 0; color: var(--skin-muted, #70879a); font-size: 12px; }
.header-actions { display: flex; align-items: center; gap: 8px; }.icon-button { width: 38px; height: 38px; border: 1px solid var(--skin-border, #d8e3eb); border-radius: 7px; background: #fff; color: var(--skin-muted, #42647e); display: grid; place-items: center; flex: none; }
.service-status { display: inline-flex; align-items: center; gap: 6px; color: var(--skin-muted, #667d8f); font-size: 12px; white-space: nowrap; }.service-status i { width: 7px; height: 7px; border-radius: 50%; background: #d7a137; }.service-status.online i { background: #21986f; }.service-status.offline i { background: #d85d55; }
.tool-tabs { max-width: 1080px; margin: 16px auto 0; padding: 0 14px; display: flex; gap: 2px; border-bottom: 1px solid var(--skin-border, #d8e3eb); }.tool-tabs button { min-height: 42px; padding: 0 18px; border: 0; border-bottom: 3px solid transparent; background: transparent; color: var(--skin-muted, #6a8091); display: flex; align-items: center; gap: 8px; }.tool-tabs button.active { color: var(--skin-brand, #0097ff); border-bottom-color: var(--skin-brand, #0097ff); font-weight: 700; }
.tool-panel { max-width: 1052px; margin: 0 auto; background: #fff; border: 1px solid var(--skin-border, #d8e3eb); border-top: 0; }.tool-content { padding: 18px; }.tool-heading { display: flex; justify-content: space-between; align-items: start; gap: 16px; margin-bottom: 14px; }.tool-heading h2 { margin: 0; font-size: 16px; }.tool-heading p { margin: 4px 0 0; color: var(--skin-muted, #71889a); font-size: 12px; }
.query-row, .draft-row { display: flex; align-items: end; gap: 10px; } label { min-width: 0; flex: 1; display: grid; gap: 6px; color: var(--skin-muted, #60788a); font-size: 12px; } input, textarea { width: 100%; border: 1px solid var(--skin-border, #cddae4); border-radius: 6px; background: #fff; color: var(--skin-ink, #243b53); padding: 9px 10px; outline: none; } input:focus, textarea:focus { border-color: var(--skin-brand, #0097ff); box-shadow: 0 0 0 2px rgba(var(--skin-brand-rgb, 0, 151, 255), 0.12); }.budget-field, .quantity-field { max-width: 105px; }
.primary-button, .secondary-button, .send-button { min-height: 38px; border-radius: 6px; padding: 0 14px; display: inline-flex; justify-content: center; align-items: center; gap: 7px; white-space: nowrap; }.primary-button, .send-button { border: 1px solid var(--skin-brand, #0097ff); background: var(--skin-brand, #0097ff); color: #fff; }.secondary-button { border: 1px solid var(--skin-border, #cbd9e3); background: #fff; color: var(--skin-muted, #42647e); }
.assistant-page :deep(.candidate-list) { display: grid; gap: 8px; margin-top: 14px; }
.assistant-page :deep(.candidate-item) { min-height: 68px; padding: 8px; display: grid; grid-template-columns: 52px minmax(0, 1fr) auto; align-items: center; gap: 10px; border: 1px solid var(--skin-border, #e0e8ee); border-radius: 7px; background: var(--skin-surface, #fbfcfd); }
.assistant-page :deep(.candidate-item img), .assistant-page :deep(.food-placeholder) { width: 52px; height: 52px; border-radius: 6px; object-fit: cover; background: var(--skin-border, #e9f3f5); color: var(--skin-brand, #0097ff); display: grid; place-items: center; }
...
.assistant-page :deep(.candidate-copy span) { margin-top: 3px; color: var(--skin-muted, #60788a); font-size: 12px; }
.assistant-page :deep(.candidate-copy small) { margin-top: 3px; color: var(--skin-muted, #8597a5); font-size: 11px; }
.assistant-page :deep(.candidate-item > button) { height: 34px; padding: 0 10px; border: 1px solid var(--skin-brand, #0097ff); border-radius: 6px; background: #fff; color: var(--skin-brand, #0097ff); display: flex; align-items: center; gap: 6px; }
.assistant-page :deep(.candidate-empty) { min-height: 66px; border: 1px dashed var(--skin-border, #cbd8e2); color: var(--skin-muted, #8599a8); display: flex; justify-content: center; align-items: center; gap: 8px; font-size: 12px; }
.media-layout { display: grid; grid-template-columns: minmax(280px, .8fr) minmax(360px, 1.2fr); gap: 18px; }.hidden-input { display: none; }.upload-zone { width: 100%; min-height: 150px; padding: 14px; border: 1px dashed var(--skin-subtle, #9cb8c9); border-radius: 7px; background: var(--skin-surface, #f8fbfc); color: var(--skin-muted, #4d6c80); display: grid; place-items: center; gap: 6px; overflow: hidden; }.upload-zone > i { color: var(--skin-brand, #0097ff); font-size: 28px; }.upload-zone b { font-size: 14px; }.upload-zone span { color: var(--skin-muted, #8397a5); font-size: 12px; }.upload-zone img { width: 100%; height: 180px; object-fit: contain; }.capability-note, .processing-note { margin: 10px 0 0; padding: 9px 10px; border-radius: 6px; font-size: 12px; }.capability-note { color: #9b6a1b; background: #fff7e7; border: 1px solid #f0d7a7; }.processing-note { color: var(--skin-brand, #0097ff); background: var(--skin-surface, #edf7ff); border: 1px solid var(--skin-border, #c9e7fb); }.recognition-summary { margin-top: 10px; padding: 10px; border-left: 3px solid var(--skin-brand, #0097ff); background: var(--skin-surface, #f2f9ff); }.recognition-summary strong, .recognition-summary span { display: block; }.recognition-summary span { margin-top: 3px; color: var(--skin-muted, #6c8394); font-size: 11px; }.keyword-list { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 8px; }.keyword-list button { border: 1px solid var(--skin-border, #b9ddf5); border-radius: 999px; background: #fff; color: var(--skin-brand, #0097ff); padding: 4px 8px; font-size: 11px; }
.capability-error { display: flex; align-items: center; gap: 7px; color: #a13d36; background: #fff1ef; border-color: #efc5c1; }.capability-error button { margin-left: auto; border: 0; background: transparent; color: var(--skin-brand, #0097ff); font-weight: 700; }
.voice-actions { display: flex; gap: 8px; }.record-button { min-height: 44px; flex: 1; border: 1px solid var(--skin-brand, #0097ff); border-radius: 6px; background: var(--skin-surface, #edf7ff); color: var(--skin-brand, #0097ff); display: flex; justify-content: center; align-items: center; gap: 8px; }.record-button.recording { border-color: #d85d55; background: #fff0ef; color: #c84740; }.voice-draft { margin-top: 12px; display: grid; gap: 10px; }.voice-draft textarea { min-height: 70px; resize: vertical; }
.chat-shell { max-width: 1052px; height: min(560px, calc(100vh - 330px)); min-height: 420px; margin: 16px auto 28px; display: flex; flex-direction: column; background: #fff; border: 1px solid var(--skin-border, #d8e3eb); }.message-list { flex: 1; min-height: 0; overflow-y: auto; padding: 18px; }.empty-chat { min-height: 100%; display: grid; align-content: center; justify-items: center; color: var(--skin-muted, #71889a); text-align: center; }.empty-chat > i { font-size: 32px; color: var(--skin-brand, #0097ff); }.empty-chat h2 { margin: 10px 0 3px; color: var(--skin-ink, #314d62); font-size: 17px; }.empty-chat p { margin: 0; font-size: 12px; }.quick-list { margin-top: 16px; display: flex; flex-wrap: wrap; justify-content: center; gap: 7px; }.quick-list button { border: 1px solid var(--skin-border, #d7e2ea); border-radius: 999px; background: #fff; color: var(--skin-muted, #526d80); padding: 7px 10px; font-size: 12px; }
.message { display: flex; gap: 9px; margin-bottom: 14px; }.message.user { flex-direction: row-reverse; }.message-avatar { width: 32px; height: 32px; border-radius: 7px; display: grid; place-items: center; flex: none; background: var(--skin-surface, #e8f4fb); color: var(--skin-brand, #0097ff); }.message.user .message-avatar { background: #e9f5f2; color: var(--skin-brand, #0097ff); }.message-body { max-width: min(76%, 720px); }.message.user .message-body { text-align: right; }.message-bubble { padding: 10px 12px; border-radius: 7px; background: var(--skin-surface, #f2f6f9); color: var(--skin-ink, #314d62); line-height: 1.6; text-align: left; font-size: 13px; overflow-wrap: anywhere; }.message.user .message-bubble { background: var(--skin-brand, #0097ff); color: #fff; }.message-body time { display: block; margin-top: 4px; color: var(--skin-muted, #94a4af); font-size: 10px; }.typing { display: flex; gap: 4px; }.typing i { width: 6px; height: 6px; border-radius: 50%; background: var(--skin-muted, #8ba1af); animation: pulse 1s infinite alternate; }.typing i:nth-child(2) { animation-delay: .2s; }.typing i:nth-child(3) { animation-delay: .4s; }
.chat-composer { padding: 10px; border-top: 1px solid var(--skin-border, #e0e8ee); }.chat-composer textarea { max-height: 120px; resize: none; }.composer-actions { min-height: 42px; padding-top: 7px; display: flex; justify-content: flex-end; align-items: center; gap: 7px; }.composer-actions > span { margin-right: auto; color: var(--skin-muted, #93a4af); font-size: 11px; }.send-button { min-width: 86px; }
.drawer-mask { position: fixed; inset: 0; z-index: 50; background: rgba(var(--skin-ink-rgb, 20, 38, 52), 0.45); display: flex; justify-content: flex-end; }.history-drawer { width: min(380px, 92vw); height: 100%; padding: 16px; background: #fff; box-shadow: -6px 0 24px rgba(var(--skin-ink-rgb, 20, 38, 52), 0.15); }.history-drawer > header { display: flex; justify-content: space-between; align-items: center; }.history-drawer h2 { margin: 0; font-size: 17px; }.history-refresh { width: 100%; margin: 14px 0; }.history-list { display: grid; gap: 7px; }.history-list > button { width: 100%; padding: 11px; border: 1px solid var(--skin-border, #e0e8ee); border-radius: 7px; background: var(--skin-surface, #fbfcfd); color: var(--skin-ink, #405f75); display: flex; align-items: center; text-align: left; }.history-list span { min-width: 0; flex: 1; }.history-list b, .history-list time { display: block; }.history-list b { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 12px; }.history-list time { margin-top: 4px; color: var(--skin-muted, #91a2ad); font-size: 10px; }.history-empty { color: var(--skin-muted, #8ba0ae); text-align: center; padding: 50px 0; }
...
.ai-topbar { min-height: 64px; padding: 10px max(14px, calc((100% - 1080px) / 2)); display: flex; align-items: center; gap: 12px; position: sticky; top: 0; z-index: 30; color: #fff; background: var(--skin-brand, #0097ff); box-shadow: 0 3px 12px rgba(var(--skin-brand-rgb, 0, 112, 204), 0.2); }
...
.feature-bubbles button { min-width: 0; min-height: 82px; padding: 13px 14px; display: grid; grid-template-columns: 42px minmax(0, 1fr) 14px; align-items: center; gap: 10px; border: 1px solid var(--skin-border, #cae7fb); border-radius: 8px; color: var(--skin-ink, #294b66); background: #fff; box-shadow: 0 7px 20px rgba(var(--skin-brand-strong-rgb, 22, 91, 139), 0.11); text-align: left; transition: transform .2s ease, border-color .2s ease, box-shadow .2s ease; }
.feature-bubbles button:hover { border-color: var(--skin-brand-soft, #76c8f8); transform: translateY(-2px); box-shadow: 0 9px 24px rgba(var(--skin-brand-rgb, 0, 126, 214), 0.16); }
.feature-icon { width: 42px; height: 42px; display: grid; place-items: center; border-radius: 8px; color: var(--skin-brand, #0097ff); background: var(--skin-surface, #e9f6ff); font-size: 18px; }
.feature-copy { min-width: 0; }
.feature-copy b, .feature-copy small { display: block; letter-spacing: 0; }
.feature-copy b { color: var(--skin-brand-strong, #1f425e); font-size: 14px; line-height: 1.35; }
.feature-copy small { margin-top: 4px; color: var(--skin-muted, #7690a4); font-size: 11px; line-height: 1.35; }
.feature-arrow { color: var(--skin-brand-soft, #9ec9e5); font-size: 11px; }
.feature-switcher { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; margin-bottom: 14px; }
.feature-switcher button { min-height: 46px; padding: 0 10px; display: flex; align-items: center; justify-content: center; gap: 7px; border: 1px solid var(--skin-border, #d5e5f0); border-radius: 7px; color: var(--skin-muted, #55748c); background: #fff; }
.feature-switcher button:hover, .feature-switcher button.active { border-color: var(--skin-brand, #0097ff); color: var(--skin-brand, #0097ff); background: var(--skin-surface, #edf7ff); }
.tool-panel { border: 1px solid var(--skin-border, #d8e8f3); border-radius: 8px; box-shadow: 0 7px 24px rgba(var(--skin-brand-strong-rgb, 31, 82, 118), 0.08); overflow: hidden; }
.tool-content { min-height: 360px; padding: 24px; }
.chat-shell { width: min(100%, 932px); height: min(680px, calc(100vh - 190px)); min-height: 500px; margin: 0 auto; padding-top: 18px; border-color: var(--skin-border, #d8e8f3); border-radius: 8px; box-shadow: 0 8px 26px rgba(var(--skin-brand-strong-rgb, 31, 82, 118), 0.09); overflow: hidden; }
.empty-chat > i { width: 54px; height: 54px; display: grid; place-items: center; border-radius: 8px; background: var(--skin-surface, #e9f6ff); }
.empty-chat h2 { color: var(--skin-brand-strong, #1f425e); }
.quick-list button:hover { border-color: var(--skin-brand-soft, #83ccf7); color: var(--skin-brand, #0088e6); background: var(--skin-surface, #f3faff); }
.message.user .message-avatar { background: var(--skin-surface, #e9f6ff); color: var(--skin-brand, #0097ff); }
.message.user .message-bubble { background: var(--skin-brand, #0097ff); }
.chat-composer { background: #fff; box-shadow: 0 -5px 16px rgba(var(--skin-brand-strong-rgb, 37, 85, 118), 0.04); }
.chat-composer textarea { min-height: 42px; border-color: var(--skin-border, #cbdfea); background: var(--skin-surface, #fafdff); }
.send-button, .primary-button { border-color: var(--skin-brand, #0097ff); background: var(--skin-brand, #0097ff); }
.send-button:hover, .primary-button:hover { background: var(--skin-brand, #0086e2); }
:global(html[data-theme="dark"]) .assistant-page { background: var(--skin-ink, #101b28); }
:global(html[data-theme="dark"]) .feature-bubbles button, :global(html[data-theme="dark"]) .feature-switcher button, :global(html[data-theme="dark"]) .tool-panel, :global(html[data-theme="dark"]) .chat-shell, :global(html[data-theme="dark"]) .chat-composer { background: var(--skin-ink, #17283a); border-color: var(--skin-ink, #29445a); }
:global(html[data-theme="dark"]) .feature-copy b { color: var(--skin-border, #e7f0f7); }
@media (max-width: 760px) {
  ...
  .feature-bubbles button { min-height: 66px; padding: 9px 11px; grid-template-columns: 38px minmax(0, 1fr) 12px; box-shadow: 0 4px 13px rgba(var(--skin-brand-strong-rgb, 22, 91, 139), 0.09); }
