...
<style scoped>
.food-category-note { color:var(--fwl-muted, #7890a0)!important; font-size:12px!important; }
/* 实时校验错误提示样式 */
.field-error-message {
...
.wrapper {
  ...
  background-color: var(--fwl-surface, #f4f8fb);
}
...
.business-info-card {
  ...
  border: 1px solid var(--fwl-border, #e4edf3);
  border-radius: 12px;
...
.operating-button {
  flex: 1;
  min-height: 40px;
  background-color: var(--fwl-brand, #007bff);
  color: #fff;
  border: 1px solid var(--fwl-brand, #007bff);
  padding: 9px 14px;
  border-radius: 6px;
  font-size: 14px;
  font-weight: 600;
...
.edit-button:hover {
  background-color: var(--fwl-brand-strong, #0056b3);
}
.operating-button{background:#fff;color:var(--fwl-brand, #168bd1);border-color:var(--fwl-brand, #168bd1);cursor:pointer}.operating-button.closed{background:var(--fwl-brand, #168bd1);color:#fff}.sold-out-label{margin-left:6px;color:var(--fwl-muted, #8a98a4);font-size:11px}.store-settings .open-setting{border-color:#bfe2cc;background:#f1faf4;color:#34895a}.store-settings .closed-setting{border-color:var(--fwl-border, #dce4e9);background:var(--fwl-surface, #f5f7f8);color:var(--fwl-muted, #7f8e99)}
...
.wrapper .food li .food-right .action-button {
  background-color: var(--fwl-brand, #0097ef);
  color: #fff;
  border: none;
  padding: 7px 11px;
  border-radius: 5px;
...
.wrapper .food li .food-right .action-button:hover {
  background-color: var(--fwl-brand, #4492fc);
}
...
.add-food-button:hover {
  background-color: var(--fwl-brand-strong, #007bb6);
}

.stock-label{font-size:12px;color:var(--fwl-muted, #7891a5);margin-left:6px}
.store-settings { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 7px; }
.store-settings span { padding: 3px 7px; border: 1px solid var(--fwl-border, #cfe3f0); border-radius: 4px; background: var(--fwl-surface, #f5fbff); color: var(--fwl-brand, #168bd1); font-size: 11px; }
.store-settings .muted-setting { border-color: var(--fwl-border, #e1e9ee); background: var(--fwl-surface, #fafcfd); color: var(--fwl-subtle, #9aadb9); }
...
<style>
.swal2-html-container .edit-field{display:block;width:90%;margin:11px auto 0;text-align:left;color:var(--fwl-muted, #45677d);font-size:13px;font-weight:600}.swal2-html-container .edit-field>span{display:block;margin:0 0 5px}.swal2-html-container .edit-field>small{display:block;margin-top:5px;color:var(--fwl-muted, #91a4b1);font-size:11px;font-weight:400}.swal2-html-container .edit-field .swal2-input,.swal2-html-container .edit-field .swal2-textarea{width:100%;margin:0;height:42px;padding:8px 11px;border:1px solid var(--fwl-border, #d8e5ee);border-radius:5px;box-sizing:border-box;font-size:14px}.swal2-html-container .edit-field .swal2-textarea{height:76px;resize:vertical}.swal2-html-container .edit-field .swal2-input:focus,.swal2-html-container .edit-field .swal2-textarea:focus{border-color:var(--fwl-brand, #58afe7);box-shadow:0 0 0 3px var(--fwl-surface, #e8f5fd);outline:0}
</style>
