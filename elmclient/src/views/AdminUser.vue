...
.manage-user-container .container {
    max-width: 600px;
    padding-top: 96px;
    padding-bottom: 72px;
    border-radius: 0;
...
.manage-user-container .top-background {
    height: 64px;
    background: #0097ff;
...
.manage-user-container .top-background::before {
    display: none;
}

.manage-user-container .top-background h1 {
    font-size: 20px;
    letter-spacing: 0;
    text-shadow: none;
}

.manage-user-container .search-section {
    position: static;
    transform: none;
    width: calc(100% - 32px);
    max-width: 568px;
...
.manage-user-container .filter-section {
    position: static;
    transform: none;
    width: calc(100% - 32px);
    max-width: 568px;
...
.manage-user-container .user-list {
    width: calc(100% - 32px);
    max-width: 568px;
    margin: 0 auto;
    transform: none;
...
.manage-user-container .user-item {
...
.manage-user-container .user-name {
    color: #24405c;
}

.manage-user-container .user-details {
    gap: 8px;
    flex-wrap: wrap;
}

.manage-user-container .user-actions .action-btn {
    box-shadow: none;
}
