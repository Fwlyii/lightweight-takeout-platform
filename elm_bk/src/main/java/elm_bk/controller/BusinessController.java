...
public class BusinessController {
     ...
     */
    @PutMapping("/{id}")
    @Operation(summary = "更新某店铺信息（覆盖）", description = "更新某店铺信息")
...
//            log.warn("更新店铺信息请求参数错误: id={}", id);
    ...
    public HttpResult<elm_bk.vo.PublicBusinessVO> publicBusiness(@PathVariable Long id) {
        return HttpResult.success(elm_bk.vo.PublicBusinessVO.from(businessService.getBusinessById(id)));
    }
