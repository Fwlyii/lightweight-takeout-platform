...
import elm_bk.dto.PersonCreateDTO;
import elm_bk.result.HttpResult;
import elm_bk.service.RegistrationService;
import elm_bk.service.CurrentProfileService;
...
public class UserRestController {
    ...
    private final elm_bk.service.ProfileUpdateService profileUpdate;
    private final elm_bk.service.AvatarUpdateService avatarUpdate;
    ...
    public PersonVO updateProfile(@Valid @RequestBody elm_bk.dto.ProfileUpdateDTO request) {
