...
class ApiContractCleanupTest {
    ...
    @MockBean com.tju.elm_bk.service.OrderService orders;
    @MockBean com.tju.elm_bk.service.MerchantInteractionService interactions;
    ...
    void merchantCanReadAggregateStatsButCannotUseCustomerInteractions() throws Exception {
        when(interactions.getMerchantStats(3L)).thenReturn(new com.tju.elm_bk.vo.MerchantStatsVO());
