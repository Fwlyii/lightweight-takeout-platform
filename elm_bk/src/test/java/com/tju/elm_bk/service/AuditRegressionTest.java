...
import com.tju.elm_bk.service.impl.*;
...
class AuditRegressionTest {
    ...
    private Configuration mapper(String name) throws Exception {
        ...
        String resource="com/tju/elm_bk/mapper/"+name+".xml";
    ...
    @Test void clearingPromotionExplicitlyWritesBothColumnsToNull() throws Exception {
        ...
        var sql=config.getMappedStatement("com.tju.elm_bk.mapper.BusinessMapper.patchBusiness")
    ...
    @Test void monthlySalesExcludeDemoBaselineAndOldOrders() throws Exception {
        ...
        String sql=config.getMappedStatement("com.tju.elm_bk.mapper.BusinessMapper.searchBusinesses")
    ...
    @Test void actualSalesQueryCountsOnlyRecentCompletedOrders() throws Exception {
        var config=mapper("BusinessMapper");
        String sql=config.getMappedStatement("com.tju.elm_bk.mapper.BusinessMapper.searchBusinesses").getBoundSql(new HashMap<>()).getSql();
