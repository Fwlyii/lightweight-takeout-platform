...
VALUES
  (1, NOW(), 0, '天津大学北洋园校区', '学生最爱的现炒套餐',
   ...
   '北洋食堂·现炒', 2.00, 6, '本地演示数据', 15.00, 2, 1),
