...
\def\cproject#1{\def\@cproject{#1}}\def\@cproject{}
...
%\cleardoublepage%
   \phantomsection
    \pdfbookmark[-1]{\@ccovertitle~\@ctitle}{ctitle}
    ...
    \begin{titlepage}
      ...
      \hei\erhao{\textbf{\@ccovertitle}} \\[22pt]
      \hei\erhao{\textbf{\@ctitle}} \\[18pt]
      {\song\sanhao\textbf{\@cproject}}
      \vspace*{24pt}
