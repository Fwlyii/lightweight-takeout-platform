...
\begin{longtable}{|L{0.21\linewidth}|L{0.24\linewidth}|L{0.50\linewidth}|}
...
顾客自助取消 & 待支付/商家接单 & 商家接单进入制作中后不提供自助取消 \\ \hline
评价评分/文字/图片 & 1--5 分；0--500 字；0--3 张 & 图片仅支持 JPG/PNG/WebP，单张最大 5 MB \\ \hline
会员 & 30 天；九五折 & 只对商品小计打折，不对配送费打折 \\ \hline
优惠券 & 每单最多 1 张 & 满足有效期、店铺/平台范围和最低金额 \\ \hline
积分抵扣 & 100 积分 = 1 元；最多 20\% & 上限基于会员和优惠券计算后金额 \\ \hline
积分发放 & 实付满1元发1分 & 仅已完成订单发放，重复确认不予补发 \\ \hline
分页 & 默认20，最大100 & 页码从 1 开始 \\ \hline
