...
\srsfigure{figures/srs/09-actor-analysis.png}{系统执行者分析图}{UML 用例图}{fig:actor-analysis}
...
\srsfigure{figures/srs/10-system-use-case.png}{系统总用例图}{UML 用例图}{fig:system-use-case}
